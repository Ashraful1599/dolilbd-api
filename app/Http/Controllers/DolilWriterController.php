...
class DolilWriterController extends Controller
{
    public function index(Request $request)
    {
        $query = User::query()
            ->where('role', 'dolil_writer')
            ->where('status', 'active')
    ...
    public function show(User $user)
    {
        ...
        // Load reviews with reviewer info (through dolils)
        ...
        return response()->json([
            ...
            'reviews' => DolilReviewResource::collection($reviews),
        ]);
    }
}
